...
async function main() {
    ...
    console.log(`📝 Creating ${pakistaniListings.length} Pakistani food listings...`);
    ...
    console.log('✅ Successfully seeded 20 Pakistani food listings!');
    console.log('📍 Locations covered: Karachi, Lahore, Islamabad, Rawalpindi, Faisalabad, Multan, Peshawar, Murree');
}
